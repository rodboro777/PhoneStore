...
if (isset($_POST["brand"]))
{
  ...
  echo "
		<div class='nav nav-pills nav-stacked'>
			<li class='active'><a href='#' style='background-color:#383838'><h4>Choose Product</h4></a></li>
	";
  if (mysqli_num_rows($run_query) > 0)
  {
	 while ($row = mysqli_fetch_array($run_query))
	 {
		...
		echo "
					<li><a href='#' class='selectBrand' style='color:#383838' bid='$bid'>$brand_name</a></li>
			";
	 }
	 echo "</div>";
  }
		...
		echo "
				<div class='col-md-4'>
							<div class='panel panel-info' style='background-color:#F8F8F8'>
								<div class='panel-heading'style='background-color:#383838' ><div style='color:white'>$pro_title</div></div>
								<div class='panel-body' style='background-color: #F8F8F8'>
									<img src='product_images/$pro_image' style='width:200px; height:200px;'/>
								</div>
								<div class='panel-heading'style='color:#383838'>$ $pro_price.00
				...
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-body'>
									<img src='product_images/$pro_image' style='width300px; height:200px;'/>
								</div>
			 ...
			 else if (isset($_SESSION["uid"]))
			 {
				...
				echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							<input type="hidden" name="business" value="shoppingcart@AppleStore.com">
				...
				'<input type="hidden" name="return" value="http://localhost/project1/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/AppleStore/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost/AppleStore/cancel.php"/>
